...
**12** Prompts · Última adição: **2026-09-16**
...
### Crie uma imagem de storyboard de 24 quadros contendo 24 capturas de tela de um potencial filme reboot de Seinfeld.
...
**Resumo:** Crie uma imagem de storyboard de 24 quadros contendo 24 capturas de tela de um potencial filme reboot de Seinfeld.
...
Perfil / Avatar · Design de Aplicativos / Web · Fotografia · Ilustração · Personagem · Publicado
...
**Resumo:** 基于两张参考图（卡通角色与X个人主页UI）生成15秒定机位2D动画，角色从头像框爬出并撕除清扫原文字，随后手写个性标语占领主页。

<img src="covers/2096842636074312057.jpg" alt="Imagem 1" width="480" />
...
### Prompt instruindo uma IA a reconstruir uma cena 3D interativa com movimentos articulados a partir de uma foto de um cômodo.
...
**Resumo:** Prompt instruindo uma IA a reconstruir uma cena 3D interativa com movimentos articulados a partir de uma foto de um cômodo.

<img src="covers/2100136611166007364.jpg" alt="Imagem 1" width="480" />

**Prompt**

```text
Com base na foto do cômodo que forneci, use o Blender MCP para construir uma cena 3D interativa e renderizá-la em um vídeo de demonstração. Inclua o movimento de objetos articulados (dobradiças, portas, gavetas) e use movimentos de câmera sensatos para mostrar esses efeitos.
```
...
```text
Conecte-se ao commandPort do Maya, modele uma cadeira de escritório comum, configure texturas fotorrealistas e renderize um turntable com o Arnold
```
