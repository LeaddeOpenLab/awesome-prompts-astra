...
[Explora Leadde.ai →](https://leadde.ai/?utm_source=github&utm_medium=readme&utm_campaign=prompt-library&utm_content=astra)
...
**14** Prompts · Última incorporación: **2026-09-23**

<a name="catalog"></a>

## Explorar por categoría

[Cine / Fotograma](#category-cinematic-film-still) · [Ilustración](#category-illustration) · [Cómic / Novela gráfica](#category-comic-graphic-novel) · [Renderizado 3D](#category-3d-render)
...
Autor：[@Chengzilhy](https://x.com/Chengzilhy) · [Publicación original](https://x.com/Chengzilhy/status/2096842636074312057)

Perfil / Avatar · Diseño de aplicaciones / web · Fotografía · Ilustración · Personaje · Publicado

Publicación original：[@Chengzilhy](https://x.com/Chengzilhy) · [Publicación original](https://x.com/Chengzilhy/status/2096456212246364322)

**Resumen:** Traducción en curso

<img src="covers/2096842636074312057.jpg" alt="Imagen 1" width="480" />
...
Autor：[@dotey](https://x.com/dotey) · [Publicación original](https://x.com/dotey/status/2102565403109085669)

Diseño de aplicaciones / web · Fotografía · Renderizado 3D · Paisaje / Naturaleza · Publicado

**Resumen:** Traducción en curso

<img src="images/2102565403109085669-1.jpg" alt="Imagen 1" width="480" />

<img src="images/2102565403109085669-2.jpg" alt="Imagen 2" width="480" />

<img src="images/2102565403109085669-3.jpg" alt="Imagen 3" width="480" />

<img src="images/2102565403109085669-4.jpg" alt="Imagen 4" width="480" />
...
### Construcción de una fábrica de clasificación de juguetes en Three.js, que abarca el transporte en cinta transportadora, la sujeción con brazo robótico y la clasificación por colores en cajas.
...
**Resumen:** Construcción de una fábrica de clasificación de juguetes en Three.js, que abarca el transporte en cinta transportadora, la sujeción con brazo robótico y la clasificación por colores en cajas.
...
```text
Crea una fábrica de clasificación de juguetes con Three.js. Una cinta transportadora transporta los juguetes, un brazo robótico los levanta y los coloca en cajas según su color.
```
...
### Prompt que instruye a una IA a reconstruir una escena 3D interactiva con movimientos articulados a partir de una foto de una habitación.

Autor：[@walterzhu8](https://x.com/walterzhu8) · [Publicación original](https://x.com/walterzhu8/status/2100136611166007364)

Fotografía · Renderizado 3D · Publicado

**Resumen:** Prompt que instruye a una IA a reconstruir una escena 3D interactiva con movimientos articulados a partir de una foto de una habitación.

<img src="covers/2100136611166007364.jpg" alt="Imagen 1" width="480" />

**Prompt**

```text
A partir de la foto de la habitación que proporcioné, usa Blender MCP para construir una escena 3D interactiva y renderízala en un video de demostración. Incluye movimiento de objetos articulados (bisagras, puertas, cajones) y utiliza movimientos de cámara razonables para mostrar estos efectos.
```
...
Implementa únicamente rotación mediante arrastre, zoom con la rueda del ratón, cambio entre dos combinaciones de colores y restablecimiento de la vista.
Conserva la distribución confirmada; cualquier altura o material no especificado debe listarse como suposición.
Una vez creada, inicia la página localmente para revisar la interacción y conserva la primera versión.
Si se presenta algún problema, corrígelo basándote en capturas de pantalla reales o mensajes de error.
```
...
Diseño de aplicaciones / web · Renderizado 3D · Publicado
...
```text
Sigue un recorrido simulado de recolección de polen a través de un prado de flores silvestres, con una superposición de búsqueda que resalta una flor a medida que la abeja se acerca.
```
...
### Instrucción para generar un modelo de terreno 3D tridimensional de un pequeño pueblo en una isla haciendo referencia a la imagen adjunta.

Autor：[@TaroKichijo](https://x.com/TaroKichijo) · [Publicación original](https://x.com/TaroKichijo/status/2097743367484621269)

Renderizado 3D · Publicado

**Resumen:** Instrucción para generar un modelo de terreno 3D tridimensional de un pequeño pueblo en una isla haciendo referencia a la imagen adjunta.
...
```text
Usa img2threejs/img2threejs para crear el terreno tridimensional de un pequeño pueblo en esta isla. Por favor, usa la imagen adjunta como imagen de referencia.
```
...
### Modelo 3D del exterior de la versión de Tokio de Tower of Terror
...
**Resumen:** Modelo 3D del exterior de la versión de Tokio de Tower of Terror
...
```text
Crea un modelo 3D del exterior de la versión de Tokio de Tower of Terror
```
